...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@ebit/ebit-swap-sdk'
import {
  Button,
  Text,
  AddIcon,
...
export default function RemoveLiquidity({
  ...
  const onRemove = async () => {
    ...
    if (approval === ApprovalState.APPROVED) {
      // removeLiquidityETH
      if (oneCurrencyIsETH) {
        methodNames = ['removeLiquidityZNX', 'removeLiquidityZNXSupportingFeeOnTransferTokens']
        args = [
    ...
    // we have a signataure, use permit versions of remove liquidity
      ...
      if (oneCurrencyIsETH) {
        methodNames = ['removeLiquidityZNXWithPermit', 'removeLiquidityZNXWithPermitSupportingFeeOnTransferTokens']
        args = [
          currencyBIsETH ? tokenA.address : tokenB.address,
          liquidityAmount.raw.toString(),
          amountsMin[currencyBIsETH ? Field.CURRENCY_A : Field.CURRENCY_B].toString(),
