...
import { Trade, TradeType } from '@ebit/ebit-swap-sdk'
import { Button, Text, AutoRenewIcon } from '@ebitempuraswap/ebitempura-swap-uikit'
            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- 0.05% towards EBIT buyback and burn</Text>
                </>
              }
              ml="4px"
            />
