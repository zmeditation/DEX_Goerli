...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@ebit/ebit-swap-sdk'
import { Button, Text, Flex, AddIcon, CardBody, Message, useModal } from '@ebitempuraswap/ebitempura-swap-uikit'
        ...
        <CardBody>
          ...
          {!addIsUnsupported ? (
            pair && !noLiquidity && pairState !== PairState.INVALID ? (
              <AutoColumn style={{ minWidth: '20rem', width: '100%', marginTop: '2rem' }}>
