import { ChainId, JSBI, Percent, Token, WETH } from '@ebit/ebit-swap-sdk'
import { BUSD, DAI, USDT, BTCB, COLA, WBNB, UST, ETH, USDC } from './tokens'

export const ROUTER_ADDRESS = '0x804D2Ab9409c4499aB070BC5AAA1C7Ab4e64C15F'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [WETH[ChainId.MAINNET], COLA[ChainId.MAINNET], BUSD[ChainId.MAINNET]],
  [ChainId.TESTNET]: [WETH[ChainId.TESTNET], COLA[ChainId.TESTNET], BUSD[ChainId.TESTNET]],
}
